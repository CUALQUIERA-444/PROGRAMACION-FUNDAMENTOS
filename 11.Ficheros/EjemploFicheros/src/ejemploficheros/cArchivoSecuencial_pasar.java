...
public class cArchivoSecuencial_pasar {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Path entrada = Paths.get("/home/cualquiera/ASIGNATURAS 1DAW/PROGRAMACION-FUNDAMENTOS/11.Ficheros/EjemploFicheros/ososconmensaje.jpg");
		Path salida = Paths.get("/home/cualquiera/ASIGNATURAS 1DAW/PROGRAMACION-FUNDAMENTOS/11.Ficheros/EjemploFicheros/mensaje.txt");
		...
		try {
			...
			istream.close();
			ostream.close();
		} catch (IOException io) { //Excepcion que sirve usualmente para errores de operacion2
