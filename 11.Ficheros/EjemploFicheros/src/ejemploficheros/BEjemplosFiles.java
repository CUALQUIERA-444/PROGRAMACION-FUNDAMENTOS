...
public class BEjemplosFiles {
	...
	public static void main(String[] args) {
		...
		// Mostrar los archivos de un directorio
		 ...
		 //Por cada path que hay dentro del string coge un path del collection {
		if (Files.isDirectory(Paths.get(".."))) {
			try {
				DirectoryStream<Path> stream = Files.newDirectoryStream(Paths.get("..")); //Se crea un collection de path
