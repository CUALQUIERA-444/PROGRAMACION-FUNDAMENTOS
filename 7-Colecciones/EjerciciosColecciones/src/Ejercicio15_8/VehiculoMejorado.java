package Ejercicio15_8;
	...
	public VehiculoMejorado(String matricula, String modelo, String marca, int año_matriculacion, int categoria) {
	...
	/*
	@Override
	public int hashCode() { //Devuelve el hashCode
		return Objects.hash(matricula);
	}
	*/
	//@Override
	/* Comparador General generable a traves de source que usan los objetos en equals
